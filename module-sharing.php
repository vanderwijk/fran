<ul class="share-this">
	...
	<li>
		<a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" 
			title="<?php _e( 'Share this on Facebook', 'fran'); ?>" 
	...
	<li>
		<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink(); ?>&amp;title=<?php the_title_attribute(); ?>"
			title="<?php _e( 'Share this on Linkedin', 'fran'); ?>" 
			rel="external nofollow" 
	...
	<li>
		<a href="mailto:?subject=<?php the_title_attribute(); ?>&amp;body=<?php the_permalink(); ?>"
			title="<?php _e( 'Share this via e-mail', 'fran'); ?>" 
			rel="nofollow" 
	...
	<li>
		<a href="https://plus.google.com/share?url=<?php the_permalink(); ?>"
			title="<?php _e( 'Share this on Google+', 'fran'); ?>" 
			rel="external nofollow" 
